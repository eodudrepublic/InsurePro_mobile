...
class _AddCustomerState extends State<AddCustomer> {
  ...
  String test_token = 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJyb2xlcyI6WyJVU0VSIl0sImlkIjoiMjAyMDU1NTEzIiwic3ViIjoidGVzdEBnbWFpbC5jb20iLCJpYXQiOjE2OTY4Mzk2MDMsImV4cCI6MTY5NzQzOTYwM30.kG3R9Xb65yXyvnBx4Frr8OCaPWclsAtqNr3_zKFBDGc';
  // 현재 테스트용 토큰으로 작업 -> 로그인 후 토큰 사용 가능한지 테스트 필요
          ...
          TextButton(
            onPressed: isFormValid()
              ...
              var response = await http.post(
                Uri.parse('http://3.38.101.62:8080/v1/customer'),
                headers: {
